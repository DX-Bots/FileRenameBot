    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Adult🔞', url='https://t.me/+bdf7FyhS344wYzRl'),
                    InlineKeyboardButton('Support', url='https://t.me/+7jxeuSvioE8zZDBl')
                ],
                [
                    InlineKeyboardButton('Channel', url='https://t.me/MoneyHeist_Hub'),
                    InlineKeyboardButton('Channel', url='https://t.me/Fannah_Ishq_Mein_Marjawaan')
                ]
            ]
        ),
